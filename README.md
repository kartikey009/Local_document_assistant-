...
The system follows a Retrieval-Augmented Generation (RAG) pipeline where documents are processed locally, converted into embeddings, stored in a persistent FAISS index, and retrieved to provide relevant context to the local LLM.
